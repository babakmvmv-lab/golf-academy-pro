/* ═══════════════════════════════════════════════════════════════════
   پات کلاب • Putt Club Golf Academy — سامانهٔ مرکزی نام‌ها و عنوان‌های رابط کاربری
...
(function(){
  ...
  const RAW = [
    ...
    ['nav.subs','منوی اصلی','💳','اشتراک‌ها'],
    ['nav.settings','منوی اصلی','🛠️','تنظیمات نمایش'],
    ['nav.messages','منوی اصلی','📨','ارسال پیام'],
    ...
    /* تب‌های پنل مدیریت */
    ['admin.academy','تب‌های پنل مدیریت','🏛️','تنظیمات آکادمی'],
    ...
    ['admin.reception','تب‌های پنل مدیریت','🛎️','رسپشن'],
    ['admin.homeskin','تب‌های پنل مدیریت','🎬','صفحه نخست'],
    ...
    ['settings.group.plans','تنظیمات نمایش','💳','پلن‌ها و اشتراک'],
  ];
