...
- سقف نسخهٔ قبلی Edge Function برای **هر بدنهٔ JSON** ۸۰۰٬۰۰۰ واحد طول رشته و حد محافظتی پنل ۷۹۰٬۰۰۰ بود. برای مشکل کلید ۸۲۳KiB، کد جدید کلاینت و سرور سقف یکسان ۲MiB بایت UTF-8 دارد؛ اعمال سمت سرور نیازمند انتشار `ga-sync` در Supabase است. پوش GitHub به‌تنهایی آن را تغییر نمی‌دهد. راهنما: `docs/DEPLOY_GA_SYNC_SIZE.md`. برای keepalive، سقف مستقل ۴۸KB مرورگر حفظ شده است.
