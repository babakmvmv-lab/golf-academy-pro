...
(function(){
  ...
  function paSvgDonut(counts, size, stroke){
    ...
    const svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="' + R + '" fill="none" stroke="rgba(255,255,255,.07)" stroke-width="' + (stroke || 26) + '"/><g transform="rotate(-90 50 50)">' + segs + '</g></svg>';
