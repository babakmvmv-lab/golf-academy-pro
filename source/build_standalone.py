...
def main():
    ...
    for jsname in ['device', 'cloud', 'labels', 'holidays', 'data', 'brand', 'sub', 'charts', 'qrcode.min', 'battle', 'landing', 'jdate', 'avatar', 'shop', 'mgmt', 'smartplay', 'leaflet', 'mis-golf', 'earthmap', 'app']:
