...
def main():
    ...
    for jsname in ['device', 'cloud', 'labels', 'holidays', 'data', 'brand', 'sub', 'charts', 'qrcode.min', 'battle', 'homeskin', 'landing', 'jdate', 'avatar', 'shop', 'mgmt', 'smartplay', 'leaflet', 'mis-golf', 'coursegeo', 'earthmap', 'app']:
